...
// Adds new menber variables/methods to the class's prototype.
...
function extendClass(superClass, members) {
	...
	// copy each menber variable/method onto the the subclass's prototype
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// A good place for subclasses to initialize menber variables
	initialize: function() {
	...
	setRange: function(range) {
		$.extend(this, range); // assigns every property to this object's menber variables
		this.updateTitle();
	},
