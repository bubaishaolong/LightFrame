...
jQuery(document).ready(function() {
    ...
    $('.js-upload-file,.js-upload-files').each(function () {
        ...
        uploader.on( 'uploadSuccess', function( file, response ) {
            ...
            // 文件上传成功后的自定义回调函数
            if (window['cj_file_upload_success'] !== undefined) window['cj_file_upload_success']();
            // 文件上传成功后的自定义回调函数
            if (window['cj_file_upload_success_'+$input_file_name] !== undefined) window['cj_file_upload_success_'+$input_file_name]();
        });
        ...
        uploader.on( 'uploadError', function( file ) {
            ...
            // 文件上传出错后的自定义回调函数
            if (window['cj_file_upload_error'] !== undefined) window['cj_file_upload_error']();
            // 文件上传出错后的自定义回调函数
            if (window['cj_file_upload_error_'+$input_file_name] !== undefined) window['cj_file_upload_error_'+$input_file_name]();
        });
        ...
        uploader.on( 'uploadComplete', function( file ) {
            ...
            // 文件上传完成后的自定义回调函数
            if (window['cj_file_upload_complete'] !== undefined) window['cj_file_upload_complete']();
            // 文件上传完成后的自定义回调函数
            if (window['cj_file_upload_complete_'+$input_file_name] !== undefined) window['cj_file_upload_complete_'+$input_file_name]();
        });
    ...
    $('.js-upload-image,.js-upload-images').each(function () {
        ...
        uploader.on( 'uploadSuccess', function( file, response ) {
            ...
            // 文件上传成功后的自定义回调函数
            if (window['cj_image_upload_success'] !== undefined) window['cj_image_upload_success']();
            // 文件上传成功后的自定义回调函数
            if (window['cj_image_upload_success_'+$input_file_name] !== undefined) window['cj_image_upload_success_'+$input_file_name]();
        });
        ...
        uploader.on( 'uploadError', function( file ) {
            ...
            // 文件上传出错后的自定义回调函数
            if (window['cj_image_upload_error'] !== undefined) window['cj_image_upload_error']();
            // 文件上传出错后的自定义回调函数
            if (window['cj_image_upload_error_'+$input_file_name] !== undefined) window['cj_image_upload_error_'+$input_file_name]();
        });
        ...
        uploader.on( 'uploadComplete', function( file ) {
            ...
            // 文件上传完成后的自定义回调函数
            if (window['cj_image_upload_complete'] !== undefined) window['cj_image_upload_complete']();
            // 文件上传完成后的自定义回调函数
            if (window['cj_image_upload_complete_'+$input_file_name] !== undefined) window['cj_image_upload_complete_'+$input_file_name]();
        });
